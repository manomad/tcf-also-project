...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        public ApiClient(String basePath="https://virtserver.swaggerhub.com/MarketplaceSimpleAPI/MarketplaceSimpleAPI/1.0.0")
        {
            BasePath = basePath;
            ...
            Dictionary<String, FileParameter> fileParams, String[] authSettings)
        {
            ...
            foreach(var param in fileParams)
                request.AddFile(param.Value.Name, param.Value.GetFile, param.Value.ContentType);
        ...
        public void UpdateParamsForAuth(Dictionary<String, String> queryParams, Dictionary<String, String> headerParams, string[] authSettings)
        {
            ...
            foreach (string auth in authSettings)
            {
                ...
                {
                    case "UserSecurity":
                        headerParams["Authenticate"] = GetApiKeyWithPrefix("Authenticate");
